...
```math
\frac{\partial L}{\partial W_1} = \frac{\partial L}{\partial a_n} \frac{\partial a_n}{\partial a_{n-1}} \cdots \frac{\partial a_2}{\partial a_1} \frac{\partial a_1}{\partial W_1}
```
...
```math
\sigma_{\mathrm{Xavier}} = \sqrt{\frac{2}{n_{in}+n_{out}}}
```

```math
\sigma_{\mathrm{He}} = \sqrt{\frac{2}{n_{in}}}
```
